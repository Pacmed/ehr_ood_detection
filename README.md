...
- [OOD Detection For Electronic Health Records](#ood-detection-for-electronic-health-records)
  * [:open_file_folder: Contents](#contents)
    ...
    + [:scroll: Included Datasets](#-scroll--included-datasets)
  * [:interrobang: Usage](#-interrobang--usage)
    + [:rocket: Setup](#-rocket--setup)
      - [:inbox_tray: Installation](#-inbox-tray--installation)
      - [:hammer_and_wrench: Automatic Code Formatting (recommended)](#-hammer-and-wrench--automatic-code-formatting--recommended-)
      - [:memo: Commit Message Template (recommended)](#-memo--commit-message-template--recommended-)
    + [:point_up: Examples](#-point-up--examples)
      - [:microscope: Experiments](#-microscope--experiments)
      - [:bar_chart: Plotting](#-bar-chart--plotting)
    + [:recycle: Replication](#-recycle--replication)
      - [Ulmer et al. (2020)](#ulmer-et-al--2020-)
    + [:mortar_board: Bibliography](#-mortar-board--bibliography)
